...
rm -r Maxwell-Equation-Solver/Maxwell-Equation-Solver/lib
rm -r Maxwell-Equation-Solver/Maxwell-Equation-Solver/include/SFML
mv $SFML_VERSION/lib Maxwell-Equation-Solver/Maxwell-Equation-Solver/
mv $SFML_VERSION/include/SFML Maxwell-Equation-Solver/Maxwell-Equation-Solver/include/
rm -r $SFML_VERSION
